...
class BannerViewState extends State<BannerView> {
  ...
  Widget _buildBannerItem(
      BuildContext context, int index, List<ExternalBannerItem> list) {
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: Theme.of(context)
                    .textTheme
                    .subtitle2!
                    .copyWith(color: const Color(0xFFdddddd), fontSize: 12),
              ),
            ))
      ]),
    );
    ...
    return BlocBuilder<HomeBloc, HomeState>(builder: ((context, state) {
      ...
      for (int i = 0; i < itemCount; i++) {
        paginationList.add(Container(
            ...
            child: Container(
                color: const Color(0xFF333333), width: 6.0, height: 3.0)));
      }
      return Container(
        ...
        child: Swiper(
            ...
            itemBuilder: ((context, index) =>
                _buildBannerItem(context, index, bannerList)),
